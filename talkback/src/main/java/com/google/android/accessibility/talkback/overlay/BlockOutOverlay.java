...
public class BlockOutOverlay extends SimpleOverlay {
    ...
    public void refresh(AccessibilityNodeInfoCompat node) {
        ...
        try {
            ...
            LogUtils.e(
                    "BlockOutOverlay", e, "Caught WindowManager.BadTokenException while displaying text.");
        }
        focusedNode = node;
    ...
    public class BlockOutOverlayView extends View {
        private final Paint blackPaint = new Paint();
        private final Paint cutPaint = new Paint();
        private final Rect nodeBounds = new Rect();

        public BlockOutOverlayView(Context context) {
            super(context);
        ...
        public void onDraw(@NonNull Canvas canvas) {
            if (focusedNode != null) {
                ...
                drawBlockOut(canvas, nodeBounds);
            }
        }

        private void drawBlockOut(Canvas canvas, Rect rectOnScreen) {
    ...
    public BlockOutOverlay(Context context) {
        ...
        highlightView = new BlockOutOverlayView(context);
